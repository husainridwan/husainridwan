...
<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=26&pause=1000&color=2E86C1&center=true&vCenter=true&width=650&lines=Hi%2C+I'm+Ridwanllah+%F0%9F%91%8B;Risk+%26+Data+Analyst+%F0%9F%93%8A;Turning+Messy+Data+Into+Decisions+%F0%9F%92%A1;SQL+%7C+Python+%7C+Power+BI+%7C+Credit+Risk" alt="Typing SVG" />
...
- 🔭 Recently built an end-to-end **Probability of Default model** that predicts the probability that a borrower will default.
...
Here's a closer look at the work behind the repos below — what each one does and the skill it's meant to prove.
...
### 🌐 [Portfolio Site](https://github.com/husainridwan/portfolio)
My personal portfolio site, the front door to everything above, built to give a quick, visual walkthrough of my work.
...
> 💬 **Why these projects?** Each one was picked to prove a different muscle: risk modeling end-to-end (PD Model), working with messy local data (Rent Predictor), production-grade pipelines (Airflow ETL), and pure exploratory storytelling (EPL Analysis).
...
I'm actively exploring entry-level **Data Analyst, Analytics Engineer, and Data Engineer** roles — remote or Lagos-based.  
Always happy to talk data, risk models, or Power BI dashboards.
